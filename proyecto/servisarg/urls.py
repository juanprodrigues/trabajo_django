...
urlpatterns = [
    ...
    path('modificar_usuario/<int:pk>/', views.modificar_user, name='modificar_usuario'),
    path('modificar_trabajador/<int:pk>/', views.modificar_trabajador, name='modificar_trabajador'),
